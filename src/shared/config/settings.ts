...
export const BP_GUIDELINES = {
  AHA_ACC: 'aha_acc', // American Heart Association / American College of Cardiology
  ESC_ESH: 'esc_esh', // European Society of Cardiology / European Society of Hypertension
